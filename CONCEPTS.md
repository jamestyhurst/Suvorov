# Suvorov concept index

This file is a pointer index, not a concept reference. Shared explanations live in
`Software_Engineering\Skill_Development\concepts\`.
...
| [git-branch-merging-and-prs](../Skill_Development/concepts/git-branch-merging-and-prs.md) | Branch `feat/world-date-and-polities` vs `origin/main` |
